...
const SingleServiceCard = ({ icon, name, count, desc }) => {
  ...
  return (
    <div
      className="bg-[var(--secondary-white)] border border-gray-200 border-opacity-60 shadow cursor-pointer transition-all duration-300 ease-in flex flex-col items-center p-8 rounded-md hover:scale-105"
      onClick={handleClick}
    >
