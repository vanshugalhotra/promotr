...
const Footer = () => {
  return (
    <footer className="footer bg-[var(--main-black)] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 justify-between items-center md:px-[100px] px-12 xs:px-24 py-4">
      ...
      <div className="footer-info-item footer-email">
        <span className="footer-info-title">Want to say Hi?</span>
        <div className="footer-info-det py-[20px] px-[2px]">
          <p className="footer-info-desc ">General Inquiries</p>
          <a
      ...
      <div className="footer-info-item footer-social">
        <span className="footer-info-title">Find us on Social Media</span>
        <div className="footer-info-det">
          <p className="footer-info-desc">social media</p>
          <div className="footer-info-links">
            ...
            <Link
              className="footer-link"
              target="_blank"
              href="https://twitter.com/promotr_co?t=8wfbhW0rHHzuD8kcE4GASw&s=08"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="1em"
